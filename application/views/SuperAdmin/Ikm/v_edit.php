    <!-- Main Content Start -->
    <h3>Halaman <?= $title ?> </h3>
    <p>Halaman ini berisi form untuk merubah pemetaan IKM</p>

    <div class="card shadow">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-primary">Edit Data Form</h5>
        </div>
            ...
            <div class="col">
                <div class="card mr-4 my-4">
                    ...
                    <div class="card-body">
                        ...
                        <?= form_open('SuperAdmin/Ikm/editForm/' . $location->id_ikm) ?>
                        ...
                        <a class="btn btn-warning" href="<?= site_url('SuperAdmin/Ikm') ?>" style="text-decoration:none">Back</a>
